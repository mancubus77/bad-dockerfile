...
#
RUN curl -LO ${CURL_OPTIONS} \
      https://buildlogs.centos.org/c7.1511.u/java-1.8.0-openjdk/20160420131424/1.8.0.91-0.b14.el7_2.x86_64/java-1.8.0-openjdk-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    curl -LO ${CURL_OPTIONS} \
      https://buildlogs.centos.org/c7.1511.u/java-1.8.0-openjdk/20160420131424/1.8.0.91-0.b14.el7_2.x86_64/java-1.8.0-openjdk-headless-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    touch /var/lib/rpm/* && \
